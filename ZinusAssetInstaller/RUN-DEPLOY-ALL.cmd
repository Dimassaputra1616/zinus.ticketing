...
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command ^
    ...
    "$cred = Get-Credential -Message 'Masukkan credential admin untuk target komputer';" ^
    "& '%SCRIPT_DIR%Deploy-ZinusAssetSync.ps1' -ComputerList '%COMPUTER_LIST%' -Token $token -Credential $cred -RunNow"
