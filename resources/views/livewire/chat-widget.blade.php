<div x-data="{ open: @entangle('isOpen') }" class="fixed bottom-6 right-6 z-50" wire:poll.2s>
    ...
    >
        ...
        @if($totalUnreadCount > 0)
            <span class="absolute -top-1 -right-1 flex h-5 w-5 items-center justify-center rounded-full bg-red-500 text-[10px] font-bold text-white shadow-md ring-2 ring-white">
                {{ $totalUnreadCount }}
            </span>
        @endif
    </button>
